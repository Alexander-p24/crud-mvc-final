...
<body>
    ...
    <form action="index.php?action=update&id=<?php echo $_GET['id']; ?>" method="POST">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" placeholder="Introduzca un telefono.." name="telefono" value=<?php echo $usuario['telefono'] ; ?>>

            <label for="" class="form-label">Contraseña</label>
            <input type="text" class="form-control" placeholder="Ingresar una contraseña ..." name="contraseña" value=<?php echo $usuario['telefono'] ; ?>>
        </div>
